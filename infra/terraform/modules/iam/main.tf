...
output "authority_service_account_email" { value = try(google_service_account.service["authority"].email, null) }
output "audit_writer_service_account_email" { value = try(google_service_account.service["audit_writer"].email, null) }
output "release_gate_service_account_email" { value = try(google_service_account.service["release_gate"].email, null) }
